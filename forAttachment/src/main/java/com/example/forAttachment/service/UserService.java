...
public class UserService {
    ...
    final UserAttachmentRepository userAttachmentRepository;

    final UserAttachmentContentRepository userAttachmentContentRepository;
    ...
    public ApiResponse getByIdUser(Integer id, HttpServletResponse response) {
        ...
        Optional<AttachmentContentUser> byAttachmentUser_id = userAttachmentContentRepository.findByAttachmentUser_Id(byUserId.get().getUser().getAttachmentUser());
